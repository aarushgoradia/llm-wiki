...
- [[2017-jouppi-tpu]] — In-Datacenter Performance Analysis of a Tensor Processing Unit (2017, ISCA) `#hardware #accelerator #inference #energy-efficiency #systems #dataflow #quantization #benchmark`
...
- [[domain-specific-architecture]] — hardware specialized for one workload class; the TPU/Horowitz thesis that efficiency now comes from specialization, not scaling
...
- [[intel-haswell]] — Xeon E5-2699 v3 server CPU; the CPU baseline in the TPU paper (hardware)
...
- [[nvidia-k80]] — Kepler server GPU (2 dies); the GPU baseline in the TPU paper (hardware)
...
- [[tensorflow]] — Google's dataflow-graph ML framework; the TPU's programming model (framework)
- [[tpu]] — Google's 256×256 8-bit systolic matrix-multiply inference ASIC; v1 (hardware)
